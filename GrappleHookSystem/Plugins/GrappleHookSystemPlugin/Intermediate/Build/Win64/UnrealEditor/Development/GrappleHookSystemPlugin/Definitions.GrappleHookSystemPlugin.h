#undef GRAPPLEHOOKSYSTEMPLUGIN_API
...
#define UE_PROJECT_NAME GrappleHookSystem
#define UE_TARGET_NAME GrappleHookSystemEditor
...
#define GRAPPLEHOOKSYSTEMPLUGIN_API DLLEXPORT
